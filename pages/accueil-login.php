...
<head>
    ...
    <link rel="icon" type="icon" href="../assets/images/Logo.ico">
                    ...
                    <section id="offre">
                            ...
                            <section class="stats">
                                ...
                                <section id="demandes" class="item">
                                    <img width="30" height="30"
                                        src="https://img.icons8.com/ios-glyphs/30/secured-letter--v1.png"
                                        alt="demandes" />
                                    <p>1</p>
                                </section>
                            </section>
                        ...
                        <section class="infos">
                            ...
                            <section id="entreprise-logo" class="item">
                                <img width="30" height="30"
                                    src="https://img.icons8.com/ios-glyphs/30/client-company.png"
                                    alt="client-company" />
                                <p>CESI Strasbourg</p>
                            </section>
                            ...
                            <section id="date" class="item">
                                <img width="30" height="30"
                                    src="https://img.icons8.com/ios-glyphs/30/google-calendar.png"
                                    alt="google-calendar" />
                                <p>08/04 - 19/07</p>
                            </section>
