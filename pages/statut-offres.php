...
<head>
    <!-- Main -->
    <meta charset="UTF-8">
    <meta name="description" content="Page des offres.">
    ...
    <link rel="stylesheet" href="../assets/styles/statut-offres.css" />
        ...
        <div class="offre">
            <section class="headerOffre">
                ...
                <section class="stats">
                    ...
                    <section class="demandes item">
                        <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/secured-letter--v1.png"
                            alt="demandes" />
                        <p>1</p>
                    </section>
                </section>
            ...
            <div class="infos">
                ...
                <section class="places item">
                    <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/conference-call--v1.png"
                ...
                <section class="boutons-offre">
                    <button type="button" class="modifier-statut">Modifier statut</button>
                    <p>Status :</p>
                    <p>En attente</p>
                </section>
            </div>
